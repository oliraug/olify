(function() {
	'use strict';
	myMarket.factory("stockDetailFactory", function (httpAuth) {
    return {
        get: function (ticker) {
...
myMarket.controller('stockDetailController', stockDetailController);
stockDetailController.$inject = ['$scope', 'httpAuth', 'errorHandler', 'stockDetailFactory', 'genericAPIFactory', 'accountManagementFactory', '$routeParams'];
function stockDetailController('stockDetailController', function ($scope, httpAuth, errorHandler, stockDetailFactory, genericAPIFactory, accountManagementFactory, $routeParams){
