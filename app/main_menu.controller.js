(function() {
	...
	menuController.$inject = ['$scope', '$rootScope', '$translate', '$location', 'AuthenticationService', 'genericAPIFactory', 'loginService'];
	function menuController($scope, $rootScope, $translate, $location, AuthenticationService, genericAPIFactory, loginService) {
