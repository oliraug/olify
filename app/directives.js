...
var app.directive('formElement', function() {
    return {
        restrict: 'E',
        transclude: true,
        scope: {
...
var app.directive('onlyNumbers', function() {
...
var app.directive('focus', function() {
    return function(scope, element) {
        element[0].focus();
    }      
});
var app.directive('animateOnChange', function($animate) {
