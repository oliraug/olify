(function() {
	'use strict';
	myMarket.factory("indicesGraphFactory", function (httpAuth) {
    return {
...
myMarket.controller('homeFinancialGraphController', homeFinancialGraphController);
homeFinancialGraphController.$inject = ['$scope', 'indicesGraphFactory'];
function homeFinancialGraphController('homeFinancialGraphController', function ($scope, indicesGraphFactory){
