...
@media screen and (max-width: 991px){
  .well .form-control{width: 15em;}
 .container .well {background: #fff;display: inline-block;float:none !important;
...
.well .form-control{width: 15em;display: block;}
 .container .well {background: #fff;display: inline-block;float:none !important;
position: relative;margin-top: 10%;}
 fieldset
{
...
<!--Login Form-->
 <div class="container"  style="width: 45em;margin-top: 3em;margin-left: 5em;">
  <!-- First row -->
  <form class="well form-horizontal" ng-click="login()" name="loginForm" method="POST" ng-controller="LoginByUsernameAndPasswordController">
    <!--div class="col-xs-12 col-md-6 col-lg-3">
      ...
      <fieldset>
        ...
        <div class="section_title"><h1><span class="fa fa-lock"></span> Login</h1></div>
          <div class="form-group" ng-class="{'has-error': loginForm.login_name.$dirty && loginForm.login_name.$error.required}">
          <label for="loginname" class="col-md-4 control-label">Login Name</label>
          ...
          <span ng-show="loginForm.login_name.$dirty && loginForm.login_name.$error.required" class="help-block"></span>
        </div>
      </div>
    </div> 
      <div class="form-group" ng-class="{'has-error': loginForm.password.$dirty && loginForm.password.$error.required}">
          ...
          <div class="col-md-4 inputGroupContainer">
            ...
            <input type="password" class="form-control" placeholder="password" id="password" ng-model="user.password" required/>
      ...
      <div>
        ...
        <input type="submit" name="action" id="action" class="btn btn-info" value="Login" ng-disabled="loginForm.$invalid"/>
      </div>
