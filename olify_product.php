...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
                    ...
                    <div class="panel-body" ng-controller="ProductController">
                        <div class="row">
                            <div class="col-sm-12 table-responsive">
                             <table id="product_data" class="table table-bordered table-striped table-hover table-checkable datatable" datatable="ng" ui-options="dataTableOpt" ng-init="getProduct()">
                         <tr class="grid-top-panel">
                             <th>Product Code</th>
                             <th>Category Name</th>
                             <th>Supplier Name</th>
                             <th>Market User</th>
                             <th ng-click='sortColumn("product_name")'>Product Name</th>
                             <th ng-click='sortColumn("units")'>Units</th>
        ...
        <div id="productModal" class="modal fade pop-details" role="dialog">
            <div class="modal-dialog">
                <form ng-submit="newProduct()" name="productForm" id="product_form" ng-controller="ProductController" class="well form-horizontal">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title"><i class="fa fa-plus"></i> Add Product</h4>
                        </div>
                        <div class="modal-body olify_product">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon"><li class="glyphicon glyphicon-list"></li></span>
                                        <select name="text" id="product_measures" class="form-control selectpicker" ng-model="product.product_measures" style="width: 5em;height: 2.8em;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="created_date" id="creat_date" class="form-control" ng-model="product.created_date" required="required" style="width: 15em;" />
                            </div>
	...
	<div id="updateProductModal" class="modal fade pop-details" role="dialog">
            <div class="modal-dialog">
                <form ng-submit="updateProduct()" name="productForm" id="product_form" ng-controller="ProductController" class="well form-horizontal">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group" ng-app="fileUpload" id="container" ng-controller="upload" enctype="multipart/form-data">
                                ...
                                <input type="file" name="files[]" multiple id="productimg" accept="image/*" fileinput="file" filepreview="filepreview" class="file-upload" ng-model="product.productimg"/>                             
...
<?php } else { ?>
      ...
      if (score.length > 0) {
        ...
        $.post("product_review_action.php", {
